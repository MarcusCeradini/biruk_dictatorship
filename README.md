...
### Upgrades Shop
1. **Hire Goon** ($100) - Adds automated turret to your family
2. **Better Weapon** ($250+) - Increases bullet damage
3. **Speed Boost** ($150+) - Move faster around the battlefield
4. **Fire Rate** ($200+) - Shoot bullets more rapidly
...
- Hire your first goon as soon as possible
- Keep moving to avoid enemy swarms

### Mid Game
- Build a balanced team of goons
- Invest in weapon upgrades for faster kills
- Use goons as defensive perimeter

### Late Game
- Max out your upgrade tree
- Position goons strategically
- Maintain aggressive playstyle with mobility
...
1. **Never Stop Moving**: Stationary targets take more damage
2. **Goon Placement**: Hire goons early for defensive coverage
3. **Economy Management**: Balance between upgrades and hiring
4. **Enemy Patterns**: Learn Phil Collins movement behaviors
